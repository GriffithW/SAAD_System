...
class ThrusterControlLeft(Node):
    def __init__(self):
        super().__init__('thruster_control_left')
        ...
        self.subscription = self.create_subscription(
            Float64,
            'thruster_left/speed',
            self.control_thruster_left_callback,
            10

        )


    def control_thruster_left_callback(self, msg):
...
def main(args=None):
    ...
    thruster_control = ThrusterControlLeft()
    try:
